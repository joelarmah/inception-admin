...
export default function ClientDevelopersPage() {
  ...
  const loadData = async () => {
    try {
      ...
      const developersData = await api.developers
        .list
        //   {
  ...
  const getAvailabilityBadge = (status: string) => {
    ...
    return (
      <span
        className={`inline-flex items-center gap-1 px-2 py-1 ${color}/20 border border-white/10 rounded-full text-xs text-white`}
      >
  ...
  const filteredDevelopers = developers.filter((developer) => {
    ...
    if (
      ...
      developer.availability_status !== availabilityFilter
    ) {
      return false;
    }
    ...
    <div className="min-h-screen">
      ...
      <div className="max-w mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-bold text-[#2b3674]">Squad</h3>
              ...
              />
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 bg-black/20 border rounded-lg text-gray focus:outline-none  [&>option]:bg-gray-900 [&>option]:text-white"
                  >
                    <option value="all" className="bg-gray-900 text-gray-400">
                      All Levels
                    </option>
                    <option value="junior" className="bg-gray-900 text-white">
                      Junior (0-2 years)
                    </option>
                    <option value="mid" className="bg-gray-900 text-white">
                      Mid-level (2-5 years)
                    </option>
                    <option value="senior" className="bg-gray-900 text-white">
                      Senior (5+ years)
                    </option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="busy" className="bg-gray-900 text-white">
                      Currently Busy
                    </option>
                  </select>
                </div>
                        ...
                        onClick={() => {
                          if (selectedTechStacks.includes(tech.name)) {
                            setSelectedTechStacks(
                              selectedTechStacks.filter((t) => t !== tech.name)
                            );
                          } else {
                            setSelectedTechStacks([
                              ...selectedTechStacks,
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            actionText=""
            onAction={() => console.log("Create Squad")}
          />
        ) : (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-4">
                  ...
                  {getAvailabilityBadge(
                    developer.availability_status || "unavailable"
                  )}
                </div>
...
//                   Marketplace
//                 </TableCell>
//                 <TableCell className="text-[#a3aed0]">12.Jan.2021</TableCell>
//                 <TableCell>
//                   <div className="flex items-center gap-2">
//                     <span className="text-[#2b3674]">75.5%</span>
//                     <Progress value={75.5} className="w-16 h-1" />
//                   </div>
//                 </TableCell>
//                 <TableCell>
...
//                   Venus DB PRO
//                 </TableCell>
//                 <TableCell className="text-[#a3aed0]">21.Feb.2021</TableCell>
//                 <TableCell>
//                   <div className="flex items-center gap-2">
//                     <span className="text-[#2b3674]">35.4%</span>
//                     <Progress value={35.4} className="w-16 h-1" />
//                   </div>
//                 </TableCell>
//                 <TableCell>
//                   <div className="flex gap-1">
...
//                   Venus DS
//                 </TableCell>
//                 <TableCell className="text-[#a3aed0]">13.Mar.2021</TableCell>
//                 <TableCell>
//                   <div className="flex items-center gap-2">
//                     <span className="text-[#2b3674]">25%</span>
//                     <Progress value={25} className="w-16 h-1" />
//                   </div>
//                 </TableCell>
//                 <TableCell>
//                   <div className="flex gap-1">
...
//                   Venus 3D Asset
//                 </TableCell>
//                 <TableCell className="text-[#a3aed0]">24.Jan.2021</TableCell>
//                 <TableCell>
//                   <div className="flex items-center gap-2">
//                     <span className="text-[#2b3674]">100%</span>
...
//                 <TableRow key={i} className="border-[#e0e5f2]">
//                   <TableCell className="text-[#2b3674] font-medium">
//                     Uranus
//                   </TableCell>
//                   <TableCell className="text-[#a3aed0]">21.Sep.2021</TableCell>
//                   <TableCell>
//                     <div className="flex items-center gap-2">
//                       <span className="text-[#2b3674]">12.2%</span>
...
//                   </div>
//                 </TableCell>
//                 <TableCell className="text-[#2b3674]">17.5%</TableCell>
//                 <TableCell className="text-[#2b3674]">2,458</TableCell>
//                 <TableCell className="text-[#a3aed0]">24.Jan.2021</TableCell>
//               </TableRow>
//               <TableRow className="border-[#e0e5f2]">
//                 <TableCell>
...
//                   </div>
//                 </TableCell>
//                 <TableCell className="text-[#2b3674]">10.8%</TableCell>
//                 <TableCell className="text-[#2b3674]">1,485</TableCell>
//                 <TableCell className="text-[#a3aed0]">12.Jun.2021</TableCell>
//               </TableRow>
//               <TableRow className="border-[#e0e5f2]">
//                 <TableCell>
//                   <div className="flex items-center gap-2">
...
//                   </div>
//                 </TableCell>
//                 <TableCell className="text-[#2b3674]">21.3%</TableCell>
//                 <TableCell className="text-[#2b3674]">1,024</TableCell>
//                 <TableCell className="text-[#a3aed0]">5.Jan.2021</TableCell>
//               </TableRow>
//               <TableRow className="border-[#e0e5f2]">
//                 <TableCell>
//                   <div className="flex items-center gap-2">
//                     <Checkbox defaultChecked />
//                     <span className="text-[#2b3674] font-medium">Venus DS</span>
//                   </div>
//                 </TableCell>
//                 <TableCell className="text-[#2b3674]">31.5%</TableCell>
//                 <TableCell className="text-[#2b3674]">858</TableCell>
//                 <TableCell className="text-[#a3aed0]">7.Mar.2021</TableCell>
//               </TableRow>
...
//                     </div>
//                   </TableCell>
//                   <TableCell className="text-[#2b3674]">12.2%</TableCell>
//                   <TableCell className="text-[#2b3674]">258</TableCell>
//                   <TableCell className="text-[#a3aed0]">17.Dec.2021</TableCell>
//                 </TableRow>
//               ))}
//             </TableBody>
//           </Table>
...
//                 </TableCell>
//                 <TableCell>
//                   <Badge className="bg-[#05cd99] text-white hover:bg-[#05cd99]/90">
//                     ✓ Approved
//                   </Badge>
//                 </TableCell>
//                 <TableCell className="text-[#a3aed0]">24.Jan.2021</TableCell>
//                 <TableCell>
//                   <div className="w-16 h-2 bg-[#4318ff] rounded-full"></div>
//                 </TableCell>
//               </TableRow>
//               <TableRow className="border-[#e0e5f2]">
//                 <TableCell className="text-[#2b3674] font-medium">
//                   Venus Dashboard Builder
//                 </TableCell>
//                 <TableCell>
//                   <Badge className="bg-[#ee5d50] text-white hover:bg-[#ee5d50]/90">
//                     ✗ Disable
//                   </Badge>
//                 </TableCell>
//                 <TableCell className="text-[#a3aed0]">30.Dec.2021</TableCell>
//                 <TableCell>
//                   <div className="w-12 h-2 bg-[#4318ff] rounded-full"></div>
//                 </TableCell>
//               </TableRow>
//               <TableRow className="border-[#e0e5f2]">
//                 <TableCell className="text-[#2b3674] font-medium">
...
//                 </TableCell>
//                 <TableCell>
//                   <Badge className="bg-[#ffce20] text-white hover:bg-[#ffce20]/90">
//                     ⚠ Error
//                   </Badge>
//                 </TableCell>
//                 <TableCell className="text-[#a3aed0]">20.May.2021</TableCell>
//                 <TableCell>
//                   <div className="w-20 h-2 bg-[#4318ff] rounded-full"></div>
//                 </TableCell>
//               </TableRow>
//               <TableRow className="border-[#e0e5f2]">
//                 <TableCell className="text-[#2b3674] font-medium">
...
//                   </Badge>
//                 </TableCell>
//                 <TableCell className="text-[#a3aed0]">12.Jul.2021</TableCell>
//                 <TableCell>
//                   <div className="w-8 h-2 bg-[#4318ff] rounded-full"></div>
//                 </TableCell>
//               </TableRow>
//             </TableBody>
//           </Table>

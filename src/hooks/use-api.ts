...
export function useApi() {
  ...
  //       body: JSON.stringify(data),
  //     }),
  //     get: () => callApi('/companies/companies'),
  ...
  //       body: JSON.stringify(data),
  //     }),
  //     list: () => callApi('/developers/profiles/')
  //   },
  //   projects: {
  ...
  //   },
  //   reference: {
  //     getDeveloperRoles: () => callApi('/reference/developer-roles'),
  //     getTechStacks: () => callApi('/developers/reference/tech-stacks'),
  //     getCompanySizes: () => callApi('/admin/reference/company-sizes'),
  //     getBusinessTypes: () => callApi('/admin/reference/business-types'),
  //     getProjectTypes: () => callApi('/reference/project-types'),
  //     getProjectCategories: () => callApi('/reference/project-categories'),
  //     getProjectScopes: () => callApi('/reference/project-scopes'),
  //     getExperienceLevels: () => callApi('/reference/experience-levels'),
  //     getBudgetTypes: () => callApi('/reference/budget-types'),
  //   },
  //   admin: {
  //     getUsers: (params?: any) => {
  //       const queryString = params ? '?' + new URLSearchParams(params).toString() : '';
